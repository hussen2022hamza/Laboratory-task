...
html:
	...
	@echo "<!DOCTYPE html><html><body><h1>Алгоритм Евклида</h1></body></html>" > report.html
	@echo "HTML файл создан: report.html"

# Создать PDF версию (требуется pandoc)
pdf:
	@if command -v pandoc > /dev/null; then \
		echo "Создание PDF файла..."; \
		pandoc -o report.pdf README.md; \
		echo "PDF файл создан: report.pdf"; \
	else \
		echo "Для создания PDF установите pandoc"; \
	fi

# Показать справку
help:
	@echo "Доступные команды:"
	@echo "  make all    - Создать все версии отчета"
	@echo "  make html   - Создать HTML версию"
	@echo "  make pdf    - Создать PDF версию (нужен pandoc)"
	@echo "  make view   - Просмотреть отчет"
	@echo "  make clean  - Удалить созданные файлы"
	@echo ""
	@echo "Содержание отчета:"
	@echo "  1. Введение и цели"
	@echo "  2. Теоретическая часть (НОД, алгоритмы)"
	@echo "  3. Реализация на Python"
	@echo "  4. Практическая часть"
	@echo "  5. Заключение"
	@echo "  6. Источники"
...
view: html
	@if command -v xdg-open > /dev/null; then \
		...
		echo "Откройте файл report.html в браузере"; \
	fi
